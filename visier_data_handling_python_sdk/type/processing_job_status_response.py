...
class RequiredProcessingJobStatusResponse(TypedDict):
    pass

class OptionalProcessingJobStatusResponse(TypedDict, total=False):
...
class ProcessingJobStatusResponse(RequiredProcessingJobStatusResponse, OptionalProcessingJobStatusResponse):
    pass
