...
class SalesforceV2AuthParamsDTO(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["loginHost"]) -> MetaOapg.properties.loginHost: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["authCode", "clientId", "clientSecret", "loginHost", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["loginHost"]) -> typing.Union[MetaOapg.properties.loginHost, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["authCode", "clientId", "clientSecret", "loginHost", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        loginHost: typing.Union[MetaOapg.properties.loginHost, str, schemas.Unset] = schemas.unset,
