...
class Result(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jobId", "dataVersion", "tenantCode", "status", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jobId", "dataVersion", "tenantCode", "status", "message", ], str]):
