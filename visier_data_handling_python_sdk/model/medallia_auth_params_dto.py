...
class MedalliaAuthParamsDTO(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["instanceUrl"]) -> MetaOapg.properties.instanceUrl: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tenantDomainName", "instanceUrl", "clientId", "clientSecret", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["instanceUrl"]) -> typing.Union[MetaOapg.properties.instanceUrl, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tenantDomainName", "instanceUrl", "clientId", "clientSecret", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        instanceUrl: typing.Union[MetaOapg.properties.instanceUrl, str, schemas.Unset] = schemas.unset,
