...
class ExtractionJobAndStatusResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class extractionJobs(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ExtractionJob']:
                        return ExtractionJob
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ExtractionJob'], typing.List['ExtractionJob']],
                ...
                def __getitem__(self, i: int) -> 'ExtractionJob':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["extractionJobs"]) -> MetaOapg.properties.extractionJobs: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["parentJobId", "parentTenantCode", "limit", "start", "extractionJobs", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["extractionJobs"]) -> typing.Union[MetaOapg.properties.extractionJobs, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["parentJobId", "parentTenantCode", "limit", "start", "extractionJobs", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        extractionJobs: typing.Union[MetaOapg.properties.extractionJobs, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
