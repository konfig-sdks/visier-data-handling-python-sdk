...
class DataVersionAndDateDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dataVersion", "dataVersionDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dataVersion", "dataVersionDate", ], str]):
