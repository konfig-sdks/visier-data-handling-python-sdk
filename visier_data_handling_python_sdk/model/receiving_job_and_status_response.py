...
class ReceivingJobAndStatusResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class receivingJobs(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ReceivingJob']:
                        return ReceivingJob
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ReceivingJob'], typing.List['ReceivingJob']],
                ...
                def __getitem__(self, i: int) -> 'ReceivingJob':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["parentJobId", "parentTenantCode", "limit", "start", "receivingJobs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["parentJobId", "parentTenantCode", "limit", "start", "receivingJobs", ], str]):
