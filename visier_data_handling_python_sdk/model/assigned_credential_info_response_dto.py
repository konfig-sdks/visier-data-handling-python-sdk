...
class AssignedCredentialInfoResponseDTO(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["credentialId", "displayName", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["credentialId", "displayName", "message", ], str]):
