...
class InternalS3AuthParamsDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bucketName", "path", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bucketName", "path", ], str]):
