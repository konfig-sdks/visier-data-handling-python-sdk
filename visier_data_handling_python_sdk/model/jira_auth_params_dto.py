...
class JiraAuthParamsDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def connectParams() -> typing.Type['JiraConnectParamsDTO']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["connectParams"]) -> 'JiraConnectParamsDTO': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["apiToken", "hostName", "connectParams", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["connectParams"]) -> typing.Union['JiraConnectParamsDTO', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["apiToken", "hostName", "connectParams", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        connectParams: typing.Union['JiraConnectParamsDTO', schemas.Unset] = schemas.unset,
