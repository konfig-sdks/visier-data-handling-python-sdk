...
class SalesforceAuthParamsDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["refreshToken", "clientId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["refreshToken", "clientId", ], str]):
