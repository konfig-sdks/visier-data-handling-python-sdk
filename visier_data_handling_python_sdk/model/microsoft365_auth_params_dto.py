...
class Microsoft365AuthParamsDTO(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            oAuthTenantId = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["oAuthTenantId"]) -> MetaOapg.properties.oAuthTenantId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["oAuthTenantId", "clientId", "clientSecret", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["oAuthTenantId"]) -> typing.Union[MetaOapg.properties.oAuthTenantId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["oAuthTenantId", "clientId", "clientSecret", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        oAuthTenantId: typing.Union[MetaOapg.properties.oAuthTenantId, str, schemas.Unset] = schemas.unset,
