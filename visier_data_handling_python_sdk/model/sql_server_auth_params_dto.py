...
class SqlServerAuthParamsDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["host", "port", "username", "password", "database", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host", "port", "username", "password", "database", ], str]):
