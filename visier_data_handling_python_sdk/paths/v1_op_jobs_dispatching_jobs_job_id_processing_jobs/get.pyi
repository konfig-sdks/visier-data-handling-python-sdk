...
from visier_data_handling_python_sdk.model.processing_job_and_status_response import ProcessingJobAndStatusResponse as ProcessingJobAndStatusResponseSchema

from visier_data_handling_python_sdk.type.status import Status
from visier_data_handling_python_sdk.type.processing_job_and_status_response import ProcessingJobAndStatusResponse

from ...api_client import Dictionary
from visier_data_handling_python_sdk.pydantic.processing_job_and_status_response import ProcessingJobAndStatusResponse as ProcessingJobAndStatusResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProcessingJobAndStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProcessingJobAndStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _processing_job_and_status_mapped_args(
        self,
    ...
    async def _aprocessing_job_and_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/op/jobs/dispatching-jobs/:jobId/processing-jobs',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _processing_job_and_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ProcessingJobAndStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocessing_job_and_status(
        self,
        dispatching_job_id: typing.Optional[str] = None,
        tenant_code: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._processing_job_and_status_mapped_args(
        ...
        return await self._aprocessing_job_and_status_oapg(
    ...
    def processing_job_and_status(
        ...
        return self._processing_job_and_status_oapg(
            query_params=args.query,
        )

class ProcessingJobAndStatus(BaseApi):
    ...
    async def aprocessing_job_and_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProcessingJobAndStatusResponsePydantic:
        raw_response = await self.raw.aprocessing_job_and_status(
            dispatching_job_id=dispatching_job_id,
            tenant_code=tenant_code,
            limit=limit,
            start=start,
        ...
        if validate:
            return ProcessingJobAndStatusResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProcessingJobAndStatusResponsePydantic, raw_response.body)
    ...
    def processing_job_and_status(
        ...
        raw_response = self.raw.processing_job_and_status(
            dispatching_job_id=dispatching_job_id,
            tenant_code=tenant_code,
            limit=limit,
            start=start,
