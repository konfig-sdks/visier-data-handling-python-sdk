...
class BaseApi(api_client.Api):
    ...
    def _job_id_status_mapped_args(
        self,
    ...
    async def _ajob_id_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/op/job-status/jobs/:jobId',
            auth_settings=_auth,
            headers=_headers,
        )
...
class JobIdStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajob_id_status(
        self,
        job_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._job_id_status_mapped_args(
            job_id=job_id,
        )
        return await self._ajob_id_status_oapg(
    ...
    def job_id_status(
        ...
        return self._job_id_status_oapg(
            query_params=args.query,
        )

class JobIdStatus(BaseApi):
    ...
    async def ajob_id_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ajob_id_status(
            job_id=job_id,
            **kwargs,
        )
        if validate:
    ...
    def job_id_status(
        ...
        raw_response = self.raw.job_id_status(
            job_id=job_id,
        )
        if validate:
            return ReceivingJobStatusResponsePydantic(**raw_response.body)
