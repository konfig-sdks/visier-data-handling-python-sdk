...
from visier_data_handling_python_sdk.model.receiving_job_and_status_response import ReceivingJobAndStatusResponse as ReceivingJobAndStatusResponseSchema
...
from visier_data_handling_python_sdk.type.receiving_job_and_status_response import ReceivingJobAndStatusResponse

from ...api_client import Dictionary
from visier_data_handling_python_sdk.pydantic.receiving_job_and_status_response import ReceivingJobAndStatusResponse as ReceivingJobAndStatusResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReceivingJobAndStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReceivingJobAndStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _receiving_job_and_status_mapped_args(
        self,
    ...
    async def _areceiving_job_and_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/op/jobs/dispatching-jobs/:jobId/receiving-jobs',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _receiving_job_and_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ReceivingJobAndStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areceiving_job_and_status(
        self,
        dispatching_job_id: typing.Optional[str] = None,
        tenant_code: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._receiving_job_and_status_mapped_args(
        ...
        return await self._areceiving_job_and_status_oapg(
    ...
    def receiving_job_and_status(
        ...
        return self._receiving_job_and_status_oapg(
            query_params=args.query,
        )

class ReceivingJobAndStatus(BaseApi):
    ...
    async def areceiving_job_and_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReceivingJobAndStatusResponsePydantic:
        raw_response = await self.raw.areceiving_job_and_status(
            dispatching_job_id=dispatching_job_id,
            tenant_code=tenant_code,
            limit=limit,
            start=start,
        ...
        if validate:
            return ReceivingJobAndStatusResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReceivingJobAndStatusResponsePydantic, raw_response.body)
    ...
    def receiving_job_and_status(
        ...
        raw_response = self.raw.receiving_job_and_status(
            dispatching_job_id=dispatching_job_id,
            tenant_code=tenant_code,
            limit=limit,
            start=start,
