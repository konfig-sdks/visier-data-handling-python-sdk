...
from visier_data_handling_python_sdk.model.receiving_job_status_response import ReceivingJobStatusResponse as ReceivingJobStatusResponseSchema

from visier_data_handling_python_sdk.type.status import Status
from visier_data_handling_python_sdk.type.receiving_job_status_response import ReceivingJobStatusResponse

from ...api_client import Dictionary
from visier_data_handling_python_sdk.pydantic.status import Status as StatusPydantic
from visier_data_handling_python_sdk.pydantic.receiving_job_status_response import ReceivingJobStatusResponse as ReceivingJobStatusResponsePydantic
...
class BaseApi(api_client.Api):
    ...
    def _job_status_mapped_args(
        ...
        if start_time is not None:
            _query_params["startTime"] = start_time
        if end_time is not None:
            _query_params["endTime"] = end_time
        if status is not None:
            _query_params["status"] = status
        args.query = _query_params
        return args

    async def _ajob_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/op/job-status/jobs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class JobStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ajob_status(
        self,
        start_time: typing.Optional[str] = None,
        end_time: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._job_status_mapped_args(
            start_time=start_time,
            end_time=end_time,
            status=status,
        )
        return await self._ajob_status_oapg(
    ...
    def job_status(
        ...
        return self._job_status_oapg(
            query_params=args.query,
        )

class JobStatus(BaseApi):
    ...
    async def ajob_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ajob_status(
            start_time=start_time,
            end_time=end_time,
            status=status,
            **kwargs,
    ...
    def job_status(
        ...
        raw_response = self.raw.job_status(
            start_time=start_time,
            end_time=end_time,
            status=status,
        )
