...
from visier_data_handling_python_sdk.model.processing_job_status_response import ProcessingJobStatusResponse as ProcessingJobStatusResponseSchema
...
from visier_data_handling_python_sdk.type.processing_job_status_response import ProcessingJobStatusResponse

from ...api_client import Dictionary
from visier_data_handling_python_sdk.pydantic.processing_job_status_response import ProcessingJobStatusResponse as ProcessingJobStatusResponsePydantic
...
request_query_receiving_job_id = api_client.QueryParameter(
    name="receivingJobId",
    style=api_client.ParameterStyle.FORM,
    schema=ReceivingJobIdSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = ProcessingJobStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProcessingJobStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _processing_job_status_mapped_args(
        self,
        tenant_code: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        start: typing.Optional[int] = None,
        receiving_job_id: typing.Optional[str] = None,
        ...
        if receiving_job_id is not None:
            _query_params["receivingJobId"] = receiving_job_id
        args.query = _query_params
        return args

    async def _aprocessing_job_status_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_limit,
            request_query_start,
            request_query_receiving_job_id,
        ):
    ...
    def _processing_job_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ProcessingJobStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocessing_job_status(
        self,
        tenant_code: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        start: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._processing_job_status_mapped_args(
            tenant_code=tenant_code,
            limit=limit,
            start=start,
            receiving_job_id=receiving_job_id,
        )
        return await self._aprocessing_job_status_oapg(
    ...
    def processing_job_status(
        ...
        return self._processing_job_status_oapg(
            query_params=args.query,
        )

class ProcessingJobStatus(BaseApi):
    ...
    async def aprocessing_job_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProcessingJobStatusResponsePydantic:
        raw_response = await self.raw.aprocessing_job_status(
            tenant_code=tenant_code,
            limit=limit,
            start=start,
            receiving_job_id=receiving_job_id,
        ...
        if validate:
            return ProcessingJobStatusResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ProcessingJobStatusResponsePydantic, raw_response.body)
    ...
    def processing_job_status(
        ...
        raw_response = self.raw.processing_job_status(
            tenant_code=tenant_code,
            limit=limit,
            start=start,
            receiving_job_id=receiving_job_id,
